...
To plot the responses on the original scale, you need to back transform them. Here, we show the how to do this for the parameter NDVI. From this code, could you do the same thing for the *Surface Roughness* variable? How would you edit/change the code?
...
You probably do not want to print out the entire code for every variable you want to plot. Can you create a *for* loop to plot these two variables?
...
One of the main comments of the reviewers was whether or not we appropriately accounted for autocorrelation. This factor can severely impact modeled results and needs to be considered. We can use a variogram analysis to investigate degree of spatial dependence of a stochastic random process.

```{r SpatialCorr, eval=T}
